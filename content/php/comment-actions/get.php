...
function getComments($conn, $username=null, $contentid=null, $parentid=null, $userid=null, $terms=null, $timestamp1=null, $timestamp2=null) {
    $query = "SELECT users.role, users.username, comments.*, content.* FROM users 
...
$result = getComments($conn, $username, $contentid, $parentid, $userid, $terms, $timestamp1, $timestamp2);
